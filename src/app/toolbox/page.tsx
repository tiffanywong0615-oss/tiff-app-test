...
export default function ToolboxPage() {
  ...
  return (
    <div className="min-h-screen pt-14 pb-20 bg-[#FFF8FB]">
      <TopHeader title={t.packingList} />

      <div className="p-4 md:p-6">
        <div className="mb-5">
          <h1 className="text-2xl font-bold text-[#2B2A33]">{t.packingList}</h1>
          <p className="text-gray-500 mt-0.5 text-sm">🧳</p>
        </div>
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-50 overflow-hidden">
            <div className="bg-gradient-to-r from-[#FF6FAE] to-[#ff8fc3] p-5 text-white">
              <div className="flex items-center gap-3 mb-3">
                ...
                <h2 className="text-lg font-bold">{t.packingListTitle}</h2>
              </div>
              <div className="flex items-center justify-between text-sm text-white/80 mb-1.5">
                <span>{completedCount} / {totalCount} {t.completedOf}</span>
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-50 overflow-hidden">
            <div className="bg-gradient-to-r from-[#FFE08A] to-[#FFD060] p-5">
              <div className="flex items-center gap-3 mb-1">
                ...
                <h2 className="text-lg font-bold text-[#2B2A33]">{t.currencyConverter}</h2>
              </div>
            ...
            <div className="p-5">
              ...
              <div className="mt-6">
                <p className="text-xs text-gray-400 mb-3 font-medium uppercase tracking-wide">{t.quickConvert}</p>
