      ...
      dailyItinerary: [
        {
          ...
          activities: [
            ...
            { id: uuidv4(), time: '21:00', type: 'Shopping', location: '下通購物街', notes: '下通為熊本縣境最大規模的購物街，擁有絕佳的購物環境、充滿各式娛樂與美食選擇，來自全熊本的人都聚集在此享受歡樂時光', cost: 0, mapQuery: '下通 熊本' },
        ...
        },
        {
          ...
          activities: [
            { id: uuidv4(), time: '08:30', type: 'Food', location: 'Licht Coffee & Cakes（精品手沖）', notes: '熊本精品咖啡', cost: 800, mapQuery: 'Licht Coffee Cakes 熊本', drivingToNext: 1.0 },
            ...
            { id: uuidv4(), time: '13:30', type: 'Sightseeing', location: '草千里之濱、阿蘇火山口景觀', notes: '阿蘇火山壯觀景色', cost: 0, mapQuery: '草千里ヶ浜', drivingToNext: 2.0 },
            { id: uuidv4(), time: '19:30', type: 'Food', location: '食道樂 とさか', notes: '別府名物地雞料理:食道樂是一家充分利用大分本地食材的居酒屋。新鮮的關鯖、比目魚和大入島生蠔等刺身拼盤特別推薦，與九州特有的甜醬油搭配絕佳。', cost: 3500, mapQuery: '食道楽 とさか 別府' },
        ...
        },
        {
          ...
          activities: [
            { id: uuidv4(), time: '09:00', type: 'Food', location: 'In Bloom Coffee', notes: '別府精品咖啡', cost: 800, mapQuery: 'In Bloom Coffee 別府', drivingToNext: 0.5 },
            { id: uuidv4(), time: '10:30', type: 'Sightseeing', location: '由布院散策、金鱗湖、湯之坪街道', notes: '由布院最著名景點', cost: 0, mapQuery: '金鱗湖 由布院' },
            { id: uuidv4(), time: '12:00', type: 'Food', location: '鰻之成瀨（極上鰻魚重）', notes: '由布院名物鰻魚料理', cost: 2500, mapQuery: '鰻の成瀬 由布院', drivingToNext: 0.5 },
        ...
        },
        {
          ...
          activities: [
            { id: uuidv4(), time: '08:30', type: 'Food', location: 'Kamenos（老屋改裝咖啡）', notes: '特色咖啡店', cost: 1000, mapQuery: 'Kamenos Coffee 九州', drivingToNext: 1.5 },
            { id: uuidv4(), time: '10:00', type: 'Sightseeing', location: '九州自然動物園', notes: '九州自然動物園 (AFRICAN SAFARI) 是日本最大的野生動物園之一，廣闊的園區內共飼養有70種、計1400隻動物。園內有大約6公里的遊獵之路「大型動物區」，遊客可以自行駕車近距離內觀察動物', cost: 0, mapQuery: '九州自然動物公園 アフリカンサファリ', drivingToNext: 1.0 },
            { id: uuidv4(), time: '13:00', type: 'Food', location: '山椒咖哩烏龍麵 菊すけ', notes: '特色咖哩烏龍麵', cost: 1500, mapQuery: '菊すけ 鳥栖', drivingToNext: 0.5 },
